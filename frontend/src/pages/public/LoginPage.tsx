...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-8 sm:py-12 relative overflow-hidden">
      ...
      {/* Centered 3D Login Card with Website Theme */}
      <div className="w-full max-w-md space-y-6 card-3d p-8 sm:p-10 border border-white/10 relative z-10">
        {/* Header */}
        <div className="text-center space-y-3">
          ...
          <h2 className="text-2xl font-black text-white tracking-tight pt-1">Welcome Back</h2>
