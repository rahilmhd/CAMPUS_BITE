  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div>
          <span className="text-xs font-bold uppercase tracking-wider text-brand-600">Menu Administration</span>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1">Food Item Management</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <FolderPlus className="w-4 h-4 text-slate-500" /> New Category
          </button>
                ...
                <tr key={food.id} className="hover:bg-slate-50/50 transition-colors">
                  <td className="py-3 px-4">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <span className="font-bold text-slate-900 block text-xs">{food.name}</span>
                  ...
                  <td className="py-3 px-4 font-black text-brand-600">₹{food.price}</td>
                  <td className="py-3 px-4 text-slate-500">~{food.preparationTime}m</td>
                  <td className="py-3 px-4">
                    <button
      ...
      {categoryModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-sm w-full p-6 space-y-4 shadow-2xl">
            <h3 className="font-bold text-slate-900 text-sm">Create Food Category</h3>
